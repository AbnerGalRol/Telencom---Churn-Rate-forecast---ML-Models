...
def model_selection(features_train, features_test, target_train, target_test):
    ...
    dummy_pred_u = model_dumy_u.predict(features_test_u)
    ...
    predict_tree_u = best_model_tree_u.predict(features_test_u)
    ...
    predict_forestu = best_model_rfu.predict(features_test_u)
    ...
    predict_lr_u = best_model_LRu.predict(features_test_u)
    ...
    lgb_predict_u = bts_u.predict(features_test_u,num_iteration=bts.best_iteration)
    ...
    predict_cb_u = best_model_CBu.predict(features_test_u)
